...
if (isset($_POST['tambah'])) {
    ...
    $duplicate = mysqli_query($conn, "SELECT * FROM user WHERE username = '$user'");
    
    if (mysqli_num_rows($duplicate) > 0 && $user!="admin"){
  ...
  $target_file_dir =  "image/";
    ...
    $query = "INSERT INTO datakaryawan VALUES ('', '$user', '$nik', '$nama', '$jabatan', '$formattedDate', '$divisi','$target_file_name')";
    ...
    <section class="add-data">
        <div class="add-form-container">
            ...
            <form action="" method="POST" name="tambah" enctype="multipart/form-data">
                ...
                <input type="password" name="cpassword" class="textfield" required> -->
